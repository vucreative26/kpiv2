import {currentMonth} from './utils.js?v=20260921-clock10';
export const emptyData=()=>({months:[],kpis:[],subtasks:[],tasks:[],urgentTasks:[],notes:[],timeEntries:[],payrolls:[],attendanceEvents:[],settings:{}});
